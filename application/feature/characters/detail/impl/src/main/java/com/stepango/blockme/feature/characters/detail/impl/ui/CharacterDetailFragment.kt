...
import com.stepango.blockme.feature.characters.detail.impl.presentation.ICharacterDetailViewModel
...
class CharacterDetailFragment : BaseViewBindingFragment(
    ...
    private val viewModel: ICharacterDetailViewModel by viewModels()
